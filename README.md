...
<p align="center">
  An open-source AI chatbot app template demonstrating Google Gemini's computer use capabilities, built with Next.js and the AI SDK by Vercel.
</p>
...
- Integration with Google Gemini's computer use tool and bash tool capabilities.
